...
class MultiheadAttentionRe(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        super(MultiheadAttentionRe, self).__init__()
    ...
    def __setstate__(self, state):
        ...
        super(MultiheadAttentionRe, self).__setstate__(state)
...
def _scaled_dot_product_attention(
    ...
    """Add edge embeddings aK to K here before matmult"""
