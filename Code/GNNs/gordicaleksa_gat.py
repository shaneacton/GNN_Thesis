...
class GordiGAT(torch.nn.Module):
    """
    ...
    def __init__(self, in_channels, out_channels, heads, add_skip_connection=True, bias=True,
                 dropout=0.6, log_attention_weights=False, num_of_layers=1):
        super().__init__()
        num_heads_per_layer = [1] + [heads] * num_of_layers  # trick - so that I can nicely create GAT layers below
        num_features_per_layer = [in_channels] + [in_channels] * (num_of_layers - 1) + [out_channels]
