...
print("tokens:", text.token_sequence.raw_word_tokens)
...
print("nltk pos:", pos_tag(text.token_sequence.raw_word_tokens))
print("nlkt NER:", ne_chunk(pos_tag(text.token_sequence.raw_word_tokens)))
