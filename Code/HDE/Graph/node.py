...
from Code.constants import ENTITY, SENTENCE, TOKEN, PASSAGE, QUERY, CANDIDATE
...
class HDENode:
    ...
    def __init__(self, type, doc_id=None, candidate_id=None, text=None,
        ...
        assert type in [ENTITY, SENTENCE, TOKEN, PASSAGE, CANDIDATE, QUERY]
        assert (ent_id == ent_token_spen is None and type != ENTITY) or \
               (ent_id is not None and ent_token_spen is not None and type == ENTITY)  # is or isn't an entity
